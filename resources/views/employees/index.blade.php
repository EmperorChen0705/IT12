        ...
        <div class="toolbar-top d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
            ...
            <div class="search-bar-wrapper">
                <form action="{{ route('employees.index') }}" method="GET" class="search-bar" autocomplete="off">
                    ...
                    <input id="employeeSearch" type="text" name="search" value="{{ request('search') }}"
                        placeholder="Search employee name, email, contact or SSS..." class="search-input"
        ...
        <div class="table-responsive">
            <table class="table align-middle">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    @else
                                        <span class="text-muted" style="font-size:0.75rem; opacity:0.7;">View Only</span>
                                    @endif
                                </div>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="empty-row text-center">No employees found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
