        ...
        <div class="table-responsive" style="margin-top:4px;">
            <table class="table align-middle">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    @else
                                        <button class="btn btn-appoint btn-sm" style="opacity:.55;cursor:not-allowed;" disabled
                                    ...
                                    @if(!$srv && in_array($b->status, ['pending', 'approved']))
                                        <a href="{{ route('services.index', ['booking_id' => $b->booking_id, 'action' => 'create']) }}"
                                            ...
                                            <i class="bi bi-tools"></i> Create Svc
                                        </a>
                                    @endif
                                </div>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="empty-row text-center">No bookings found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
